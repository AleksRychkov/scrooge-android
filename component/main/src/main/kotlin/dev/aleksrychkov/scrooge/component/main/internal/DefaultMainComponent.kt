...
internal class DefaultMainComponent(
    ...
    private fun child(
        ...
        when (config) {
            Config.Transactions ->
                MainComponentInternal.Child.Transactions(TransactionsComponent(componentContext = componentContext))

            Config.Report ->
                MainComponentInternal.Child.Report(ReportComponent(componentContext = componentContext))

            Config.Settings ->
                MainComponentInternal.Child.Settings(SettingsComponent(componentContext = componentContext))
        }
