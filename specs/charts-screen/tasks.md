...
- [ ] Apply the missing currency predicate to existing report queries. (R2)
- [ ] Extend `ReportDao`, `ReportMapper`, and `DefaultReportDao`; normalize sorting and missing buckets. (R3, R4)
- [ ] Add report API use cases, default implementations, and DI registrations. (R3, R4)
...
- [ ] Register `presentation:component:balance-line-chart`; implement public API, retained UDF state, mapper, and Vico content. (R3, R5)
- [ ] Add balance reducer/mapper tests and state previews. (R3)
