...
import dev.aleksrychkov.scrooge.common.database.TransactionDao
import dev.aleksrychkov.scrooge.common.database.internal.mapper.TransactionMapper
...
internal class DefaultTransactionDao(
    ...
    override suspend fun get(
        ...
        database.transactionQueries
            .selectFromTo(fromTimestamp, toTimestamp)
            .asFlow()
